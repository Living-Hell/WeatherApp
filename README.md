...
Enter the name of the city, click "Show" or press "Enter" to get detailed weather information.
Dynamic Weather 
Display: Displays temperature, feels like temperature, minimum and maximum temperature, pressure, humidity, wind speed, and wind direction.
Responsive Design: 
Designed to provide a seamless experience on various screen sizes.
Getting Started
Clone the repository
Install dependencies with npm install.
Obtain an API key from OpenWeatherMap and replace the placeholder in the code with your key.
